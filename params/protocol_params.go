...
var (
	...
	GenesisDifficulty      = big.NewInt(1)    // Difficulty of the Genesis block (set to 1 for testing).
	MinimumDifficulty      = big.NewInt(1)    // The minimum that the difficulty may ever be (set to 1 for testing).
